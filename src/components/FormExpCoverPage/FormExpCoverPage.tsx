...
// For use classes to components.
// import classes from './FormExpCoverPage.module.scss';
import './FormExpCoverPage.module.scss';

type FormExpCoverPageProps = {
  //
};

const FormExpCoverPage = () => {
  const {
    handleSubmit,
    register,
...
export default FormExpCoverPage;
